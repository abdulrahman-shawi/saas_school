...
import { 
  Home, Building2, School, UserSquare2, Users, ChevronRight, ChevronLeft, LogOut, BookOpen,
  Download, CalendarClock, BadgeDollarSign,
} from "lucide-react";
    ...
    },
    {
      ...
      items: [
        ...
        ...(isAcademyAdmin
          ...
          : []),
        ...(isAcademyAdmin
          ? [{ icon: BadgeDollarSign, label: "رسوم الطلاب", href: "/dashboard/admin/student-fees" }]
          : []),
        ...(isAcademyAdmin
        ...
        ...(isAcademyAdmin
          ...
          : []),
        ...(isAcademyAdmin
          ? [{ icon: CalendarClock, label: "جدول الحصص", href: "/dashboard/admin/timetable" }]
          : []),
        ...(isAcademyAdmin
          ? [{ icon: BookOpen, label: "المواد", href: "/dashboard/admin/subjects" }]
          : []),
        ...(isSuperAdmin
